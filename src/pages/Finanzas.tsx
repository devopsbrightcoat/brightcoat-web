...
export const Finanzas = () => {
  ...
  const expensesPagination = usePagination(expenses ?? [])
          ...
          {loadingExpenses ? (
            ...
            <>
              ...
              <Pagination
                ...
                onChange={expensesPagination.setPage}
              />
            </>
          )}
        </div>
            ...
            <>
              <div className="min-h-0 flex-1 overflow-auto">
                <table className="w-full text-left text-sm">
                  ...
                  <tbody>
                    {servicesPagination.pageItems.map((service) => (
              ...
              <Pagination
                ...
                onChange={servicesPagination.setPage}
              />
            </>
          )}
        </div>
